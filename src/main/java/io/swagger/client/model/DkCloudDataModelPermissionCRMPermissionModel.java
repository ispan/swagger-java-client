...
public class DkCloudDataModelPermissionCRMPermissionModel {
  /**
   * Gets or Sets prospects
   */
  @JsonAdapter(ProspectsEnum.Adapter.class)
  public enum ProspectsEnum {
    FULL("Full"),
    ...
    public static ProspectsEnum fromValue(String text) {
      for (ProspectsEnum b : ProspectsEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ProspectsEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ProspectsEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ProspectsEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return ProspectsEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("Prospects")
  private ProspectsEnum prospects = null;
  ...
  public DkCloudDataModelPermissionCRMPermissionModel prospects(ProspectsEnum prospects) {
  ...
  **/
  ...
  public ProspectsEnum getProspects() {
    return prospects;
  }

  public void setProspects(ProspectsEnum prospects) {
    this.prospects = prospects;
  }

  public DkCloudDataModelPermissionCRMPermissionModel reports(ReportsEnum reports) {
  ...
  **/
  ...
  public DkCloudDataModelPermissionCRMPermissionModel dashboard(DashboardEnum dashboard) {
  ...
  **/
  ...
  public DkCloudDataModelPermissionCRMPermissionModel settings(SettingsEnum settings) {
  ...
  **/
  ...
  public DkCloudDataModelPermissionCRMPermissionModel enabled(EnabledEnum enabled) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DkCloudDataModelPermissionCRMPermissionModel dkCloudDataModelPermissionCRMPermissionModel = (DkCloudDataModelPermissionCRMPermissionModel) o;
    return Objects.equals(this.prospects, dkCloudDataModelPermissionCRMPermissionModel.prospects) &&
        Objects.equals(this.reports, dkCloudDataModelPermissionCRMPermissionModel.reports) &&
        Objects.equals(this.dashboard, dkCloudDataModelPermissionCRMPermissionModel.dashboard) &&
        Objects.equals(this.settings, dkCloudDataModelPermissionCRMPermissionModel.settings) &&
        Objects.equals(this.enabled, dkCloudDataModelPermissionCRMPermissionModel.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prospects, reports, dashboard, settings, enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DkCloudDataModelPermissionCRMPermissionModel {\n");
